...
if (empty($faltantes)) {
    ...
    if (!$conexion) {
        ...
        $consulta =  "SELECT A.id as idCliente ,A.usuario,A.nombre,A.mail,A.perfil,B.nombre, B.rfc, B.telefono, B.email, B.contacto, B.razonSocial,B.tipoCliente  FROM usuarios A INNER JOIN clientes B ON A.id = B.idUsuario WHERE A.usuario='$user' and A.password='$pass' and A.perfil='CLIENTE'";
