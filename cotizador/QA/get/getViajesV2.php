...
if (!empty($faltantes)) {
    ...
    if (!$conexion) {
        ...
        $consulta =  "SELECT A.id, A.unidad, B.idTipoPrecio, B.precio FROM viajes A INNER JOIN precio_viaje B ON A.id = B.idViaje WHERE A.id ='$idCliente' AND A.estatus IN ('Gastos', 'En proceso cliente', 'En proceso', 'En trayecto')";
